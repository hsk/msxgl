...
void tickP1() {
  ...
  for (u16 i = 0; i < 125; ++i) V9_SetSpritePatternP1(i, frame);
...
void initP2() {
  ...
  V9_FillVRAM16(V9_CellAddrP2(0, P1_HORIZON_Y + 1), 160,
                (27 - P1_HORIZON_Y) * 128);  // Draw sea
...
void tickP2() {
  ...
  u8 frame = (g_Frame >> 2) % 6;
  for (u16 i = 0; i < 125; ++i) V9_SetSpritePatternP2(i, frame);
...
void initBmp() {
  ...
  for (u8 i = 0; i < 48; ++i)
    V9_WriteVRAM((u32)(0 + (u32)(512 * (u32)(512 + 0 + i))),
                  g_DataV9BG + 128 * i, 128);

  for (u8 i = 0; i < 24; ++i)
    V9_WriteVRAM((u32)(0 + (u32)(512 * (u32)(512 + 48 + i))),
                  g_DataV9Font + 128 * i, 128);

  for (u8 i = 0; i < 16; ++i)
    V9_WriteVRAM((u32)(0 + (u32)(512 * (u32)(512 + 72 + i))),
                  g_DataV9Chr + 128 * i, 128);
...
void main() {
  ...
  while (1) {
    ...
    if (Keyboard_IsKeyPressed(KEY_R)) displayMSX();
